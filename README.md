...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-18 10:32`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/6bb92a64-f831-4c10-b498-20920ad606db.git
$ cd 6bb92a64-f831-4c10-b498-20920ad606db
```
